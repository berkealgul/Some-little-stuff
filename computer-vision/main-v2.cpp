//
// Created by berkealgul on 22.01.2021.
//
...
Rect ROI_RECT(Point(826, 14), Point(1050, 57)); //1366_768
...
int main(int argc, char **argv)
{
    ...
    initialize_agents(agents, "/home/berkealgul/Masaüstü/volorant/icons/"+ RES);
